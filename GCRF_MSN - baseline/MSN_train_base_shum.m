function [alpha,beta,MSE_train_GCRF_BASE, output] = MSN_train_base_shum(Ytrain,Rtrain,S, n1, n2)
...
MSE_train_GCRF_BASE = (reshape(Ytrain,[n,1]) - mu)' * (reshape(Ytrain,[n,1]) - mu)/n;
